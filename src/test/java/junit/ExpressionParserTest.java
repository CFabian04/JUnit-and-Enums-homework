...
public class ExpressionParserTest {
	...
	@Test(expected =ValidationException.class)
	public void incorrectOperandShouldThrowException() {
		new StringExpression("8 abc 2");
		throw new org.siit.ValidationException("You have inserted an incorrect operand");
	}


	//implement the following tests
	//that were moved from evaluator test class
	...
	private int parseAndEvaluate(String parseExpression) {
		StringExpression parse = new StringExpression(parseExpression);
		return ExpressionEvaluator.evaluate(parse);
	}
